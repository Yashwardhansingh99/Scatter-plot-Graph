...
import  { ScatterChart, Scatter, XAxis, 
  ...
  //Creating const for App 
  const App = () => {
  
    // Sample data that has been provided
    const data = [
      {
        "Alcohol": 1,
        "Malic Acid": 14.23,
    ...
    //Returning the data from the data that has been provided above
    return (
        <ScatterChart width={900} height={900}>
            <CartesianGrid />
            <XAxis type="number" dataKey="Color intensity" />  
            <YAxis type="number" dataKey="Hue" />
